          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="melody/images/faces/face1.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('melody/melody/images/faces/face6.jpg')}}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
                  ...
                  <ul class="solid-bullet-list">
                    <li>
                      ...
                      <div class="image-layers">
                        ...
                        <img class="img-sm rounded-circle image-layer-item" src="{{asset('melody/images/faces/face3.jpg')}}" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="{{asset('melody/images/faces/face5.jpg')}}" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="{{asset('melody/images/faces/face8.jpg')}}" alt="profile"/>
                      </div>
                    </li>
                    <li>
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="melody/images/faces/face13.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="melody/images/faces/face2.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Mae Saunders
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="melody/images/faces/face11.html" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Marguerite Phillips
                          </td>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="melody/images/faces/face1.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            South Shyanne
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="melody/images/faces/face4.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            Omerbury
                          </td>
